...
+============+====================+===========+==================================================+
| |image1|   | |supervisor1_name| | |s1_ti|   | |supervisor1_field|                              |
+------------+--------------------+-----------+--------------------------------------------------+
| |image2|   | |supervisor2_name| | |s2_ti|   |  |supervisor2_field|                             |
+------------+--------------------+-----------+--------------------------------------------------+
| |image1|   | |supervisor3_name| | |s2_ti|   |  |supervisor3_field|                             |
+------------+--------------------+-----------+--------------------------------------------------+
...
领域特定语言编译器：
• 针对国产芯片架构特点，提出领域特定语言DSL
• 支持大模型场景下，计算和通信算子自动生成
...
.. |supervisor3_name| replace:: 袁晟
.. |s3_ti| replace:: Supervisor
.. |supervisor3_field| replace:: 探索基于triton的高性能训练技术，通过多种现代编译加速技术，使用编译子图划分、编译融合等方式，提升国产计算体系的整体效能。
